...
<div class="side-by-side">
    <div class="toleft">
        <img class="image" src="{{ site.url }}/{{ site.testleft }}" alt="Alt Text">
        <figcaption class="caption">Test photo by Sun</figcaption>
    </div>
...
<div class="side-by-side">
    ...
    <div class="toright">
        <img class="image" src="{{ site.url }}/{{ site.testright }}" alt="Alt Text">
        <figcaption class="caption">Test photo by Sun</figcaption>
    </div>
</div>
{% endhighlight %}
